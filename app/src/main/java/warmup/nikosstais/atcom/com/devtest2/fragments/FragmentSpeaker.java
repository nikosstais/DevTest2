...
public class FragmentSpeaker extends Fragment {
    ...
    public static FragmentSpeaker newInstance(int columnCount) {
        FragmentSpeaker fragment = new FragmentSpeaker();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (view.getTag() instanceof List){
            speakerList = (List<Speaker>) view.getTag();
        }
    ...
    public interface OnListFragmentInteractionListener {
        void onListFragmentInteraction(Speaker item);
    }
}
